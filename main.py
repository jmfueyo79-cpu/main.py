...
class PipelineTradingAlphaTelegram:
    ...
    def cargar_estado(self):
        if os.path.exists(self.archivo):
            try: with open(self.archivo, 'r') as f: return json.load(f)
            except: pass
        return {"posiciones": {}}
    ...
    def procesar(self):
        ...
        for ticker in tickers:
            try:
                ...
                # --- REGLAS DE ENTRADA (Minimizando riesgo) ---
    ...
    def gestionar_maximizar(self):
        ...
        for ticker in tickers:
            try:
                ...
                # Gestión: Parcial + Trailing "Deja correr"
                if rend >= 15.0 and not pos["parcial"]:
                    pos["parcial"] = True
                    pos["stop"] = pos["entrada"] # Break even
